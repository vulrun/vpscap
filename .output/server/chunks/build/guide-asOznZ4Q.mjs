import { _ as _sfc_main$4 } from './MainHeading-Q1n572Mv.mjs';
import { _ as _sfc_main$5, c as cn } from './index-DhYCmpoC.mjs';
import { mergeProps, withCtx, createTextVNode, unref, createVNode, computed, toValue, getCurrentInstance, onServerPrefetch, ref, resolveDynamicComponent, openBlock, createBlock, shallowRef, nextTick, toRef, useSSRContext } from 'vue';
...
import { a as useLocalRef, b as useApi, c as useSlotAsText } from './hooks-CHj_C_Hn.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_GuideContent, {
        active_step: unref(activeStep),
        steps: stepLabels,
        step_key: "configure_vps"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>Lets make changes to the nginx configuration, and few more configurations. Just execute the below command</p>`);
            _push2(ssrRenderComponent(_component_CopyText, { textToCopy: "npm run setup-vps-conf" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode("p", null, "Lets make changes to the nginx configuration, and few more configurations. Just execute the below command"),
              createVNode(_component_CopyText, { textToCopy: "npm run setup-vps-conf" })
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=guide-asOznZ4Q.mjs.map
