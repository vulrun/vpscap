...
$.extend(true, DataTable.defaults, {
  dom: "<'grid grid-cols-1 md:grid-cols-2'" + "<'self-center'l>" + "<'self-center place-self-end'f>" + "<'my-2 col-span-2 border border-gray-200 rounded min-w-full bg-white dark:bg-gray-800 dark:border-gray-700'tr>" + "<'self-center'i>" + "<'self-center place-self-end'p>" + ">",
...
$.extend(DataTable.ext.classes, {
  ...
  sFilterInput: "border placeholder-gray-500 ml-2 px-3 py-1 rounded border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500 dark:placeholder-gray-400",
  sLengthSelect: "border px-1 py-1 rounded border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500",
  sProcessing: "dt-processing uk-panel",
  tailwindcss: {
    paging: {
      active: "font-medium bg-gray-100 dark:bg-gray-700/75",
    ...
    thead: {
      ...
      cell: "text-gray-900 bg-gray-100/75 font-semibold text-left dark:text-gray-50 dark:bg-gray-700/25",
    },
    tbody: {
...
DataTable.ext.renderer.pageButton.tailwindcss = function (settings, host, idx, buttons, page, pages) {
  ...
  var attach = function (container, buttons) {
    ...
    for (i = 0, ien = buttons.length; i < ien; i++) {
      ...
      if (Array.isArray(button)) {
        ...
        if (btnDisplay) {
          var className = classes.button + " " + (active ? classes.active : classes.notActive) + " " + (enabled ? classes.enabled : classes.notEnabled);
  ...
  if (paginationEl.length) {
    ...
    paginationEl = hostEl.html('<div class="text-center dark:text-gray-100"/>').children("div");
  }
