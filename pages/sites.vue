...
const availableSiteCols = [
  ...
  },
  {
    ...
    sortingFn: (rowA, rowB, columnId) => sortData({ sortOrder: "asc", numberFirst: true })(rowA?.original?.confName, rowB.original?.confName),
  },
  {
    accessorKey: "domain",
  ...
  },
  {
    ...
    cell: ({ row }) => h("div", { class: cn(["font-mono text-xs text-pink-600 truncate w-[320px]", { "text-gray-500 opacity-40": !row?.original?.isActive }]) }, row.getValue("target")),
  },
  {
    id: "actions",
