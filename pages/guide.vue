...
const { data: stepStatuses, status, error, refresh, clear } = useAsyncData("prerequisite", () => useApi(`/api/verify`));
...
<template>
  <div class="w-full max-w-screen-ld mx-auto space-y-4">
    ...
    <div class="w-full grid md:grid-cols-[320px_1fr] lg:grid-cols-[400px_1fr]">
      <GuideSidebar :active_step="activeStep" :steps="stepLabels" :statuses="stepStatuses?.prerequisite" :onUpdate="changeStep" />
